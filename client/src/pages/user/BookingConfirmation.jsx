...
import { createBooking } from '../../features/booking/bookingSlice' // Ensure correct path
...
function BookingConfirmation() {
    ...
    const handleReserve = () => {
        ...
        dispatch(createBooking({
            ...
            .unwrap() // Wait for the Promise to resolve (Success) or reject (Error)
            .then(() => {
                alert("Booking Request Sent Successfully!")
                navigate('/my-bookings') // <--- REDIRECT TO MY TRIPS
            })
            .catch((error) => {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <button
                            ...
                            className="w-full bg-slate-800 hover:bg-slate-900 dark:bg-white dark:hover:bg-gray-200 text-white dark:text-slate-900 py-4 rounded-xl font-black text-lg tracking-wide uppercase transition-all shadow-xl hover:shadow-2xl disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center"
                        >
                            {isProcessing ? (
